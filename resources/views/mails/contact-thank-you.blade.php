...
<head>
    ...
    <style>
        ...
        h2 { color: #2d3e50; font-size: 20px; }
        p { color: #4b5563; font-size: 16px; line-height: 1.6; }
        .info-box { background-color: #f0f4f8; border-left: 4px solid #007bff; padding: 10px 15px; margin-top: 15px; border-radius: 5px; font-size: 14px; }
        .footer { margin-top: 30px; font-size: 13px; color: #9ca3af; text-align: center; }
...
<div class="container">
    ...
    <p>Thank you for contacting <strong>{{ config('app.name') }}</strong>. We’ve received your message and will get back to you shortly.</p>
    ...
    <div class="info-box">
        ...
        <strong>Message:</strong> {!! nl2br(e($user_message)) !!}
    </div>
