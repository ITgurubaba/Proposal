    ...
    )
    {
        try {
            ...
            $order->fill([
                ...
                'first_name' => $this->user->name ?? $shippingAddress['first_name'] ?? '',
                'last_name' => $this->user->last_name ?? $shippingAddress['last_name'] ?? '',
                'email' => $this->user->email ?? $shippingAddress['email'] ?? '',
            ]);
